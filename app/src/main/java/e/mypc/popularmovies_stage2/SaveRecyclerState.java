...
public class SaveRecyclerState extends RecyclerView
{
    private static final String SAVED_SUPER_STATE = "super-state";
    private static final String SAVED_LAYOUT_MANAGER = "layout-manager-state";

    private Parcelable mLayoutManagerSavedState;
    public SaveRecyclerState(@NonNull Context context) {
        super(context);
    }

    public SaveRecyclerState(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public SaveRecyclerState(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
